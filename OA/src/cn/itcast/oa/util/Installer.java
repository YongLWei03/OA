...
public class Installer {
	...
	public void install(){
		...
		menu2=new Privilege("审批模板管理","/formTemplate_list",menu);			
		menu3=new Privilege("起草申请","/formFlow_formTemplateList",menu);	
		menu4=new Privilege("待我审批","/formFlow_myTaskList",menu);			
		menu5=new Privilege("我的申请查询","/formFlow_myApplicationList",menu);	
		session.save(menu);
		session.save(menu1);		
		session.save(menu2);
		session.save(menu3);
