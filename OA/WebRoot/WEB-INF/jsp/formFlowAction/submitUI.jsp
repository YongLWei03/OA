...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="formFlow_submit"  enctype="multipart/form-data">
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
					<tr>  
						<td><s:a action="formTemplate_download?id=%{formTemplateId}"  cssStyle="text-decoration: underline">[点击下载文档模板文件]</s:a></td>
					</tr>
                </table>
            </div>
        </div>
