	...
	<center>
		<div class="ItemBlock_Title1" style="width: 98%">
			...
			<span style="margin-left:30px;"><s:a action="topic_addUI?forumId=%{#topic.forum.id}">
				<img align="absmiddle" src="style/blue/images/button/publishNewTopic.png"/>
				</s:a>
			</span>
		</div>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<td width="3" class="ForumPageTableTitleLeft">&nbsp;</td>
					...
					<td class="ForumPageTableTitle" align="right" style="padding-right:12px;">
						<s:a class="detail" action="reply_addUI?topicId=%{#topic.Id}"><img border="0" src="style/images/reply.gif" />回复</s:a>
						<a href="moveUI.html"><img border="0" src="style/images/edit.gif" />移动到其他版块</a>
						<a href="#" onClick="return confirm('要把本主题设为精华吗？')"><img border="0" src="style/images/forum_hot.gif" />精华</a>
						<a href="#" onClick="return confirm('要把本主题设为置顶吗？')"><img border="0" src="style/images/forum_top.gif" />置顶</a>
						<a href="#" onClick="return confirm('要把本主题设为普通吗？')"><img border="0" src="style/images/forum_comm.gif" />普通</a>
					</td>
